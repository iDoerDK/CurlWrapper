...
${OBJECTDIR}/curlwrapper.o: curlwrapper.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/curlwrapper.o curlwrapper.c
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/newsimpletest.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.c} -lcurl  -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/curlwrapper_nomain.o: ${OBJECTDIR}/curlwrapper.o curlwrapper.c 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/curlwrapper.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/curlwrapper_nomain.o curlwrapper.c;\
	else  \
